    ...
    return (
        <div className={s.backgrpund}>
            ...
            <div className={s.container}>
                <h1 className={s.header}>A video games Application</h1>
                <h3 className={s.paragraph} >Welcome to the guiding star in your world of gaming. We are gladly sharing over 500,000+ games. Experience what this App can do!</h3>
